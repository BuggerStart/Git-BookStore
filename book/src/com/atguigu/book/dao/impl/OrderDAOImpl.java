...
/**
 * @author Keith
 * @create 2022-09-27 下午 9:54
 */
public class OrderDAOImpl extends BaseDAO<OrderBean> implements OrderDAO {
    @Override
    public void addOrderBean(OrderBean orderBean) {
        int orderBeanId = super.executeUpdate("INSERT INTO t_order values(0,?,?,?,?,?)", orderBean.getOrderNo(), orderBean.getOrderDate(), orderBean.getOrderUser(), orderBean.getOrderMoney(), orderBean.getOrderStatus());
